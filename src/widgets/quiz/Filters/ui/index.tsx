		...
		>
			...
			<div className='flex-1'>
				...
				<Select>
					...
					<SelectContent>
						<SelectItem value={EnQuizStatusesEntity.ACTIVE}>
							Активные
						</SelectItem>
						<SelectItem value={EnQuizStatusesEntity.FINISHED}>
							Завершенные
						</SelectItem>
					</SelectContent>
				</Select>
			...
			<div className='flex-1 overflow-hidden'>
				...
				<Select>
					...
					<SelectContent>
						<SelectItem value={EnQuizSortTypesEntity.DATE_PUBLISH_ASC}>
							По возрастанию по дате публикации
						</SelectItem>
						<SelectItem value={EnQuizSortTypesEntity.DATE_PUBLISH_DESC}>
